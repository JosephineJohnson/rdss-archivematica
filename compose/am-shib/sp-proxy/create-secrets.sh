...
AM_DASHBOARD_CERT="sp-am-dash-cert.pem"
AM_DASHBOARD_CSR="${AM_DASHBOARD_HOST}.csr"
AM_DASHBOARD_KEY="sp-am-dash-key.pem"

AM_STORAGE_SERVICE_CERT="sp-am-ss-cert.pem"
AM_STORAGE_SERVICE_CSR="${AM_STORAGE_SERVICE_HOST}.csr"
AM_STORAGE_SERVICE_KEY="sp-am-ss-key.pem"
